...
with open(r'D:\Search\MSA\MOSEI\MOSEI_unsplit.pkl', 'rb') as f:
    data = pickle.load(f)
    ...
    for index in range(len(data['text'])):
        if (data['mode'][index])== 'train':
            ...
            text_mask_train.append(data['text'][index])
            vision_train.append(data['video'][index])
            ...
            text_mask_valid.append(data['text'][index])
            vision_valid.append(data['video'][index])
            ...
            text_mask_test.append(data['text'][index])
            vision_test.append(data['video'][index])
