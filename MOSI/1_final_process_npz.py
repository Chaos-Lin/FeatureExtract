...
def __init_MESIC():
    # 读取audio的特征
    audio_data = np.load('D:\Search\MSA\MOSI\AudioFeature\\audioFeature.npz')
    ...
    # 读取video的特征
    video_data = np.load('D:\Search\MSA\MOSI\VideoFeature\\videoFeature.npz')
    ...
    # 读取label
    path = "D:\Search\MSA\MOSI\MOSI_raw\\label.csv"
    # todo
    ...
    with open(r'D:\Search\MSA\MOSI\unaligned_unsplit_data.pkl', 'ab') as f:
